#!/bin/bash
# demo.sh - runs the encrypted-chat scenario in three visible tmux panes:
#   left pane    = server
...
#
# requires tmux (macOS: brew install tmux) and the cryptography library
...
(
  ...
  sleep 3   # keypair generation takes a moment
